...
try {
    ...
    $results.Add((Run-Case `
        ...
        -Action {
            ...
            $rawBaseUrl += ('&apiKeyAlt={0}&sessionIdBackup={1}' -f `
            ...
            $rawBaseUrl += ('#access_token={0}&apiKeyAlt={1}&sessionIdBackup={2}' -f `
            ...
            $expectedBaseUrl += '&apiKeyAlt=[REDACTED]&sessionIdBackup=[REDACTED]'
            ...
            $expectedBaseUrl += '#access_token=[REDACTED]&apiKeyAlt=[REDACTED]&sessionIdBackup=[REDACTED]'
